...
var customMarkers = [];
var savedMarkers = JSON.parse(sessionStorage.getItem(SAVED_MARKERS_DOHERIM_KEY));
if (savedMarkers) {
...
map.on('popupopen', function(e) {
    ...
    $('#clickHere').click(function() { 
        ...
        sessionStorage.setItem(SAVED_MARKERS_DOHERIM_KEY, JSON.stringify(savedMarkers));
    });
});
